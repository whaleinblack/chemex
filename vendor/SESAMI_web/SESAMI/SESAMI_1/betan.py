...
class BETAn:
    def __init__(
        ...
        if selected_gas == "Argon":
            self.selected_gas_cs = 0.142e-18  # mÂ²/molecule; Ref: 10.1039/D1TA08021K
        elif selected_gas == "Nitrogen":
            self.selected_gas_cs = 0.162e-18  # mÂ²/molecule; Ref: 10.1039/D1TA08021K
        # elif selected_gas == "Carbon dioxide":
        #     self.selected_gas_cs = 0.142e-18  # mÂ²/molecule; Ref: 10.1039/D1TA08021K
        # elif selected_gas == "Krypton":
        #     self.selected_gas_cs = 0.210e-18  # mÂ²/molecule; Ref: 10.1039/D1TA08021K
        elif selected_gas == "Custom":
            # Multiply by 1e-20 to convert to mÂ²/molecule, from Ã…Â²/molecule
    ...
    def eswdata(self, data, eswpoints=3):
        ...
        Outputs:
            ...
            eswarea: numpy.float64. The surface area in mÂ²/g corresponding to the 'Loading' at which 'phi' is minimum.
        """
        data = data.copy(deep=True)
    ...
    def linregauto(self, p, q, data):
        ...
        # qm[=]mmol/g[=]mol/kg
        # self.N_A[=]atoms/mol
        # self.selected_gas_cs[=]mÂ²/atom
        # Factor of 1000 to convert from mmol to mol.
        # A_BET[=]mÂ²/g
        A_BET = qm * self.N_A * self.selected_gas_cs / 1000  # mÂ²/g
